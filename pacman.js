//random enemy type spawns, look to lines 206 and on
var pacman = (function() {
    // animation frame
    var frame = 0;
    ...
    function setupPlayField() {
        ...
        var randG = Math.floor((Math.random() * 5) + 1);//sets random enemy list
        // add ghosts
		if (randG ==1){
        pacman.ghosts = [];
		...
		pacman.ghosts = [];
        pacman.ghosts.push(new pacman.Enemy("inky", pacman.enemyStarts[0]));
        pacman.ghosts.push(new pacman.Enemy("inky", pacman.enemyStarts[1]));
        pacman.ghosts.push(new pacman.Enemy("inky", pacman.enemyStarts[2]));
        pacman.ghosts.push(new pacman.Enemy("inky", pacman.enemyStarts[3]));
		}
		else if (randG==3){
		pacman.ghosts = [];
        pacman.ghosts.push(new pacman.Enemy("blinky", pacman.enemyStarts[0]));
        pacman.ghosts.push(new pacman.Enemy("pinky", pacman.enemyStarts[1]));
        pacman.ghosts.push(new pacman.Enemy("blinky", pacman.enemyStarts[2]));
        pacman.ghosts.push(new pacman.Enemy("pinky", pacman.enemyStarts[3]));
		}
		else if (randG==4){
		pacman.ghosts = [];
        pacman.ghosts.push(new pacman.Enemy("clyde", pacman.enemyStarts[0]));
        pacman.ghosts.push(new pacman.Enemy("clyde", pacman.enemyStarts[1]));
        pacman.ghosts.push(new pacman.Enemy("inky", pacman.enemyStarts[2]));
        pacman.ghosts.push(new pacman.Enemy("inky", pacman.enemyStarts[3]));
		}
		else {
		pacman.ghosts = [];
        pacman.ghosts.push(new pacman.Enemy("pinky", pacman.enemyStarts[0]));
        pacman.ghosts.push(new pacman.Enemy("clyde", pacman.enemyStarts[1]));
        pacman.ghosts.push(new pacman.Enemy("inky", pacman.enemyStarts[2]));
        pacman.ghosts.push(new pacman.Enemy("pinky", pacman.enemyStarts[3]));
		}
