//look at line 41, Base speed now randomized
// "toolset"
// helper functions
pacman.tools = (function() {
	...
	var zzz = Math.floor((Math.random() * 60) + 75);	//sets random speed for all of it, range of 60-135
    ...
    function enemySpeed(mode, elroyLevel) {
        ...
        switch (mode) {
            ...
            case "fright":
                return 0.6 * (zzz + level) / 100 * base;
            default:
                // in other modes: levels 1-19 (75 + level + elroyLevel * 5)%  base speed
                if (level < 20) {
                    return (zzz + level + elroyLevel * 5) / 100 * base;
                }
